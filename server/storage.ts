...
export class MemStorage implements IStorage {
  ...
  private seedData() {
    ...
    const productsData: InsertProduct[] = [
      {
        name: "SADOER 5x Vitamin C Complete Set",
        slug: "sadoer-vitamin-c-complete-set",
        sku: "SKU-001",
        description: "Complete vitamin C skincare set with cleanser, toner, lotion, cream, and serum. Perfect for brightening and whitening with visible results in just weeks.",
        shortDescription: "Reduces dark spots & hyperpigmentation",
        price: 180.00,
        originalPrice: 220.00,
        image: "@assets/IMG_7692.JPG",
        gallery: [],
        categoryId: 1,
        brandId: 1,
        rating: 4.5,
      ...
      {
        name: "SADOER Facial Serum 4-in-1",
        slug: "sadoer-facial-serum-4in1",
        sku: "SKU-002",
        description: "Advanced 4-in-1 facial serum with Hyaluronic Acid, Niacinamide, Vitamin C and Vitamin E. Repair and nourish your skin with deep moisturizing and brightening benefits.",
        shortDescription: "4-in-1 repair & nourish formula",
        price: 89.00,
        originalPrice: 120.00,
        image: "@assets/IMG_7693.JPG",
        gallery: [],
        categoryId: 1,
        brandId: 1,
        rating: 5.0,
        ...
        isOrganic: false,
        size: "30ml",
        productType: "Facial Serum",
        madeIn: "Ghana",
        shelfLife: "12 months",
        ingredients: "Hyaluronic Acid 10%, Niacinamide 5%, Vitamin C 30%, Vitamin E 10%",
        highlights: [
          "Advanced 4-in-1 formula with premium ingredients",
          "Fade skin wrinkles and firm filling",
          "Deep locking moisture for all-day hydration"
        ],
        perfectFor: [
        ...
        whyGhanaLovesIt: "This serum works perfectly in Ghana's humidity, providing deep hydration without feeling greasy. The 4-in-1 formula saves time while delivering professional skincare results.",
        importantNotes: "For external use only. Apply sunscreen during the day when using this product. Store in a cool, dry place.",
        howToUse: [
          "Cleanse face thoroughly",
          "Apply 2-3 drops to clean, dry skin",
        ...
        whatsIncluded: "1 x 30ml SADOER Facial Serum 4-in-1 in glass dropper bottle"
      },
      {
        name: "SADOER Facial Cream 4-in-1",
        slug: "sadoer-facial-cream-4in1",
        sku: "SKU-003",
        description: "Premium facial cream with 4-in-1 repair and nourish formula. Contains Hyaluronic Acid, Niacinamide, Vitamin C and Vitamin E for ultimate skin hydration and brightening.",
        shortDescription: "Repair & nourish face cream",
        price: 95.00,
        originalPrice: 130.00,
        image: "@assets/IMG_7695.JPG",
        gallery: [],
        categoryId: 1,
        brandId: 1,
        rating: 4.0,
        ...
        ingredients: "Hyaluronic Acid 10%, Niacinamide 5%, Vitamin C 30%, Vitamin E 10%",
        highlights: [
          "Premium 4-in-1 repair and nourish formula",
          "High moisturizing and brightening properties",
          "Perfect for daily facial care routine"
        ],
        perfectFor: [
          "Dry and dull skin",
          "Those seeking anti-aging benefits",
          "Daily facial moisturizing needs"
        ],
        whyGhanaLovesIt: "This rich face cream provides perfect hydration for Ghana's climate while delivering visible anti-aging and brightening results.",
        importantNotes: "For external use only. Apply sunscreen during the day when using this product.",
        howToUse: [
          "Cleanse face thoroughly",
        ...
        whatsIncluded: "1 x 50g SADOER Facial Cream 4-in-1 with box packaging"
      },
      {
        name: "SADOER Fruit Mango Body Butter",
        slug: "sadoer-fruit-mango-body-butter",
        sku: "SKU-004",
        description: "Tender care mango body butter for smooth skin, whitening and moisturizing. Made from pure natural ingredients for ultimate skin nourishment.",
        shortDescription: "Moisturizing skin care body butter",
        price: 65.00,
        originalPrice: null,
        image: "@assets/IMG_7696.JPG",
        gallery: [],
        categoryId: 5,
        brandId: 5,
        rating: 4.5,
